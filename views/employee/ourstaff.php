                    ...
                    <div class="details">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($d->insert("employee", $data)) {
                                if ($ext) {
                                    move_uploaded_file($_FILES['pic']['tmp_name'], "images/staff/" .  $d->Id  . ".$ext");
                                }
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="text" name="name" id="form_fname" class="input-text" placeholder="Full Names"><span style="color:red" class="error_fname" id="fname_error_message"></span>
                            </div>
                            <div class="form-group">
