...
<div class="form-content-box">
    <div class="details">
        <div class="main-title">
            <h1>Add Your<span> update</span></h1>
        </div>
        <?php
        $d = new Database();
        ...
        if (isset($_POST['save'])) {
            ...
            if ($d->update("menu", $data, array("id" => $_GET['id']))) {
                if ($ext1) {
                    $filePathName = "images/menu/" . md5("ab-1-" . $_GET['id'] . "-idb-project") . ".$ext1";
                    ...
                    move_uploaded_file($_FILES['pic1']['tmp_name'], $filePathName);
                }
                echo "<p style='color : blue;'>update Succesfully</p>  " . $filePathName;
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <button type="submit" name="save" class="button-md button-theme ">Update</button>                                <a href="index.php?e=menu-view" class="button-md button-theme ">View</a>  
